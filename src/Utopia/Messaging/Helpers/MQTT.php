 ...
 * agnostic ΓÇö pass binary blobs in/out, the caller handles sockets.
 */
class MQTT
{
    ...
    public static function encodeConnect(
        ...
        if ($password !== null) {
            if ($username === null) {
                throw new \InvalidArgumentException('MQTT 5 ┬º3.1.2.9 forbids setting a password without a username.');
            }
            $flags |= 0x40;
        }
        if ($username !== null) {
